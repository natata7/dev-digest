ALTER TABLE "pr_intent" ADD COLUMN "confidence" text DEFAULT 'medium' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "pr_intent" ADD COLUMN "computed_at" timestamp with time zone DEFAULT now();